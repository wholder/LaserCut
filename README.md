...
### Issue with JSSC and Java 9 on Windows 10
There appears to be an issue with using JSSC with Java 9 and/or Windows 10 that causes a crash when you try to select a serial port.  Currently under investigation.
# Important Note
